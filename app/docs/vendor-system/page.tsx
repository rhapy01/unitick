        ...
        <div className="flex gap-8">
                        ...
                        {section.items.map((item) => (
                          <Link
                            ...
                            className={`block text-sm py-1 px-2 rounded transition-colors ${
                              item.href === '/docs/vendor-system' ? 'bg-accent text-accent-foreground' : 'hover:bg-accent'
                            }`}
                          >
                            {item.title}
                          </Link>
          ...
          <div className="flex-1 max-w-4xl">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-3xl font-bold">Vendor System</h1>
            </div>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  The UniTick Vendor System is a comprehensive platform that enables businesses to offer their services through blockchain-based ticketing. Learn about becoming a vendor, managing your business, and growing your customer base.
                </p>

                {/* Who is a Vendor */}
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold mb-6">Who is a UniTick Vendor?</h2>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-lg">Service Providers</h3>
                          </div>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-lg">Business Types</h3>
                          </div>
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  ...
                  <div className="bg-gradient-to-r from-primary/5 to-blue-500/5 rounded-lg p-6 border border-primary/10">
                    <h3 className="font-bold mb-4 text-lg">What Vendors Do</h3>
                    <div className="grid md:grid-cols-3 gap-4 text-sm">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">List Services</div>
                        <p className="text-muted-foreground">Create and manage ticket offerings</p>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">Receive Payments</div>
                        <p className="text-muted-foreground">Get paid automatically via blockchain</p>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">Verify Tickets</div>
                        <p className="text-muted-foreground">Scan QR codes to validate bookings</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold mb-6">Vendor System Components</h2>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-lg">Requirements & Verification</h3>
                          </div>
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Business verification process</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Wallet whitelist requirements</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Compliance and security checks</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-lg">Management Tools</h3>
                          </div>
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  ...
                  <div className="bg-gradient-to-r from-primary/5 to-blue-500/5 rounded-lg p-6 border border-primary/10">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 text-sm">
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground">Access customers worldwide</p>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">Secure Payments</div>
                        <p className="text-muted-foreground">Blockchain-verified transactions</p>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">Easy Integration</div>
                        <p className="text-muted-foreground">Simple setup and management</p>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Review Requirements</h3>
                              <p className="text-muted-foreground mb-4">
                                Understand what's needed to become a verified vendor on UniTick.
                              </p>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Complete Verification</h3>
                              <p className="text-muted-foreground mb-4">
                                Submit your business information and complete the verification process.
                              </p>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Setup Wallet</h3>
                              <p className="text-muted-foreground mb-4">
                                Configure your payment wallet and complete the whitelist process.
                              </p>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Start Selling</h3>
                              <p className="text-muted-foreground mb-4">
                                Access your vendor dashboard and begin listing your services.
                              </p>
