        ...
        <div className="flex gap-8">
                        ...
                        {section.items.map((item) => (
                          <Link
                            ...
                            className={`block text-sm py-1 px-2 rounded transition-colors ${
                              item.href === '/docs/phase-1' ? 'bg-accent text-accent-foreground' : 'hover:bg-accent'
                            }`}
                          >
                            {item.title}
                          </Link>
          ...
          <div className="flex-1 max-w-4xl">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-3xl font-bold">Phase 1: Enhanced Ownership</h1>
            </div>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Phase 1 focuses on strengthening the core ownership experience and establishing a solid foundation for advanced features. This phase enhances user control over their NFT tickets and improves the overall platform stability.
                </p>

                {/* Phase 1 Features */}
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold mb-6">Enhanced Ownership Features</h2>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Advanced Ticket Management</h3>
                              <p className="text-muted-foreground mb-4">
                                Enhanced dashboard with better ticket organization, filtering, and search capabilities for managing large collections.
                              </p>
                              <div className="bg-muted/50 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Advanced filtering by date, vendor, status</span>
                                </div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Search tickets by service name</span>
                                </div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Bulk actions for multiple tickets</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Custom ticket collections</span>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Improved Transfer System</h3>
                              <p className="text-muted-foreground mb-4">
                                Enhanced ticket transfer capabilities with better security, verification, and user experience.
                              </p>
                              <div className="bg-muted/50 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">One-click ticket transfers</span>
                                </div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Transfer confirmation system</span>
                                </div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Transfer history tracking</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Recipient notification system</span>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-muted-foreground mb-4">
                                Strengthened security measures including multi-factor authentication, transaction monitoring, and fraud prevention.
                              </p>
                              <div className="bg-muted/50 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                ...
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Transaction monitoring alerts</span>
                                </div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Enhanced wallet security</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-6">Platform Improvements</h2>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          ...
                          <ul className="space-y-2 text-sm">
                            ...
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Improved caching system</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Reduced API response times</span>
                            </li>
                          </ul>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-bold text-lg">User Experience</h3>
                          </div>
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            ...
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Streamlined user flows</span>
                            </li>
                          </ul>
                        </CardContent>
                      </Card>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-6">Phase 1 Goals</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <Card>
                        <CardContent className="p-6 text-center">
                          ...
                          <h3 className="font-bold mb-2">Ownership Control</h3>
                          <p className="text-sm text-muted-foreground">Give users complete control over their NFT tickets</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        <CardContent className="p-6 text-center">
                          ...
                          <p className="text-sm text-muted-foreground">Establish robust security measures for user protection</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        <CardContent className="p-6 text-center">
                          ...
                          <h3 className="font-bold mb-2">Platform Stability</h3>
                          <p className="text-sm text-muted-foreground">Ensure reliable performance and user experience</p>
                        </CardContent>
                      </Card>
                    </div>
                  </div>
                      ...
                      <CardContent className="p-6">
                        ...
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-center gap-2">
                            ...
                            <span>Enhanced ticket management dashboard</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span>Improved transfer system</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                          ...
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span>Mobile experience improvements</span>
                          </li>
                        </ul>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-6">
                        ...
                        <ul className="space-y-2 text-sm">
                          ...
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span>90% user satisfaction score</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
