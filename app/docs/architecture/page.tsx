                        ...
                        {section.items.map((item) => (
                          <Link
                            ...
                            className={`block text-sm py-1 px-2 rounded transition-colors ${
                              item.href === '/docs/architecture' ? 'bg-accent text-accent-foreground' : 'hover:bg-accent'
                            }`}
                          >
                            {item.title}
                          </Link>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-8">
                        ...
                        <CardContent className="p-6">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              ...
                              <span>Next.js 15 with React 19</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            ...
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Viem for blockchain interaction</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          ...
                          <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Ethereum-compatible (Base Sepolia)</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>ERC-721 NFT tickets</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>ERC-20 UTICK token</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            ...
                            <li className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span>Vendor whitelist system</span>
                            </li>
                          </ul>
                        </CardContent>
                      </Card>
                  ...
                  <div className="bg-gradient-to-r from-primary/5 to-blue-500/5 rounded-lg p-6 border border-primary/10">
                    <h3 className="font-bold mb-4 text-lg">Architecture Benefits</h3>
                    <div className="grid md:grid-cols-3 gap-4 text-sm">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">Scalable</div>
                        <p className="text-muted-foreground">Handles growing user base</p>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary mb-1">Modern</div>
                        <p className="text-muted-foreground">Latest web technologies</p>
                      </div>
                    </div>
                  </div>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">User Interaction</h3>
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="bg-muted/50 rounded-lg p-4">
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Blockchain coordination</span>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-bold text-lg mb-2">Blockchain Execution</h3>
                              <p className="text-muted-foreground mb-4">
                              ...
                              <div className="bg-muted/50 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Transaction execution</span>
                                </div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                ...
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                  <span className="font-medium">Payment distribution</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <Card>
                      <CardContent className="p-6">
                        <h3 className="font-bold mb-3 text-lg">Technology Stack</h3>
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-center gap-2">
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <h3 className="font-bold mb-3 text-lg">Deployment</h3>
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                          ...
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span>Supabase Cloud (Backend)</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
